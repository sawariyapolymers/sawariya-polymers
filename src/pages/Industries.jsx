...
const industries = [
  ...
  { name: 'Home Care', desc: 'Durable bottles for liquid dish wash, glass cleaners, disinfectants, floor cleaners, phenyle, and acid storage.', products: ['PET Bottles', 'HDPE Jerricans', 'Caps'] },
  { name: 'Agro Chemicals', desc: 'Chemical-resistant bottles and jerricans for pesticides, herbicides, and fertilizers — built for safe storage and handling.', products: ['HDPE Jerricans', 'PET Bottles', 'Caps'] },
  ...
  { name: 'Industrial Chemicals', desc: 'Heavy-duty HDPE jerricans and PET bottles for acids, solvents, lubricants, and industrial chemical storage.', products: ['HDPE Jerricans', 'PET Bottles', 'Caps'] },
