      ...
      <section className="section timeline-section">
        <div className="container">
          ...
          <div className="timeline">
            ...
            <div className="timeline-item"><div className="timeline-dot"></div><span className="timeline-year">Expansion</span><h3>Product Range Expanded</h3><p>Added bottles, jars, caps, handles, 20 litre bubble tops, and HDPE jars and containers to the product lineup, serving more industries.</p></div>
